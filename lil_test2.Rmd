...
szoveg <- as.character(review_detailed$comments)
szoveg <- tolower(szoveg)
reuters <- VCorpus(VectorSource(szoveg[leaflet_sample]))
reuters <- tm_map(reuters, removePunctuation)
reuters <- tm_map(reuters, removeNumbers)
reuters <- tm_map(reuters, removeWords, stopwords("SMART"))
reuters <- tm_map(reuters, removeWords, stopwords("german"))
